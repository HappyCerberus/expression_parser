...
${OBJECTDIR}/_ext/e84f65c/expression_evaluator.o: /home/simon/advantech/expression_evaluator.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e84f65c/expression_evaluator.o /home/simon/advantech/expression_evaluator.c

${OBJECTDIR}/expression_parser.o: expression_parser.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/expression_parser.o expression_parser.c
...
${TESTDIR}/_ext/b1f7d4ae/complex_expressions.o: /home/simon/advantech/tests/complex_expressions.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/b1f7d4ae/complex_expressions.o /home/simon/advantech/tests/complex_expressions.c


${TESTDIR}/_ext/b1f7d4ae/evaluation.o: /home/simon/advantech/tests/evaluation.c 
	${MKDIR} -p ${TESTDIR}/_ext/b1f7d4ae
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/b1f7d4ae/evaluation.o /home/simon/advantech/tests/evaluation.c


${TESTDIR}/tests/simple_parsing.o: tests/simple_parsing.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/simple_parsing.o tests/simple_parsing.c
...
${OBJECTDIR}/_ext/e84f65c/expression_evaluator_nomain.o: ${OBJECTDIR}/_ext/e84f65c/expression_evaluator.o /home/simon/advantech/expression_evaluator.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e84f65c/expression_evaluator_nomain.o /home/simon/advantech/expression_evaluator.c;\
	else  \
...
${OBJECTDIR}/expression_parser_nomain.o: ${OBJECTDIR}/expression_parser.o expression_parser.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/expression_parser_nomain.o expression_parser.c;\
	else  \
